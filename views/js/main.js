...
function animate() {
  if (!animated) {
    scrollDelta = document.body.scrollTop / 1250;
...
var elem;
var movingPizzaSection = document.getElementById("movingPizzas1");
var pizzaWidth = Math.floor(window.innerWidth / 73.333);
var pizzaHeight = Math.floor(window.innerHeight /100);
var numOfPizzas = Math.floor(pizzaWidth * pizzaHeight / 4);
